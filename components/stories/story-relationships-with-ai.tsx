...
interface StoryRelationshipsWithAIProps {
  storyId: string
  storyTitle: string
...
export function StoryRelationshipsWithAI({
  storyId,
  storyTitle,
  storyDescription,
  parentStory,
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-muted-foreground mt-1 flex items-center gap-2">
            ...
            {showProgram &&
              story.program_name &&
              story.program_id !== currentProgramId && (
  ...
  const currentRelatedStoryIds = relatedStories.map((s) => s.story_id)
  ...
  return (
    <CollapsibleSection
      ...
      defaultOpen={true}
      badge={totalRelationships || undefined}
    >
      <div className="space-y-5">
        ...
        <AIRelationshipSuggestions
          ...
          currentRelatedStories={currentRelatedStoryIds}
          currentParentStoryId={currentParentStoryId}
        />
        ...
        {totalRelationships === 0 && (
          <p className="text-sm text-muted-foreground italic">
            No relationships defined yet. Use the AI suggestion feature above to
