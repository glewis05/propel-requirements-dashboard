...
// Type aliases for test_patients table operations
type TestPatientsInsert = Database['public']['Tables']['test_patients']['Insert']
type TestPatientsUpdate = Database['public']['Tables']['test_patients']['Update']
...
export async function createTestPatient(data: TestPatientFormData) {
  ...
  const insertData: TestPatientsInsert = {
...
export async function updateTestPatient(
  ...
  const updateData: TestPatientsUpdate = {}
...
export async function deactivateTestPatient(patientId: string) {
  ...
  const deactivateData: TestPatientsUpdate = { is_active: false }
...
export async function reactivateTestPatient(patientId: string) {
  ...
  const reactivateData: TestPatientsUpdate = { is_active: true }
